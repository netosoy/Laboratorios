...
int main(void){
  ...
  //Funny printings
  cout<<"el valor asignado al la variable nemero es: "<<numero<<endl;
  ...
  cout <<"\n El valor de la variable numero antes de la funcion void square (ptr) es : " <<*ptr_num <<endl;
  square(ptr_num) ;
  cout <<" El valor de la variable numero despues de la funcion void square (ptr) es : " <<*ptr_num <<endl;;
  }
